...
from utils.markdown_cleaner import clean_markdown_code
...
class FixAndCompileAgent:
    ...
    def fix_file(self, target_path, context_stitcher):
        ...
        context = context_stitcher.stitch_context(target_path)
